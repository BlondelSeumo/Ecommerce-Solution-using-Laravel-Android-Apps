            ...
            <h3 class="box-title">Choose / Set Banner for the "{{language.name}}"</h3>
              <div class="row">
                <div class="col-12 col-md-4">
                  <figure class="banner-image "v-for="banner in language.banners" v-if="banner.type == 37">
                ...
                <div class="col-12 col-md-5">
                  <figure class="banner-image "v-for="banner in language.banners" v-if="banner.type == 33">
                    <img data-toggle="modal" data-target="#bannerModal"  @click="updateBannerId(banner.banners_id,banner.banners_title)"  class="img-fluid"v-bind:src="'/'+banner.path" alt="Banner Image">
                  </figure>
                </div>
                <div class="col-12 col-md-3">
                  <figure class="banner-image "v-for="banner in language.banners" v-if="banner.type == 35">
                    <img data-toggle="modal" data-target="#bannerModal"  @click="updateBannerId(banner.banners_id,banner.banners_title)"  class="img-fluid"v-bind:src="'/'+banner.path" alt="Banner Image">
                  </figure>
                </div>
              </div>
              <div class="row">
                <div class="col-12 col-md-4">
                  <figure class="banner-image "v-for="banner in language.banners" v-if="banner.type == 38">
                    <img data-toggle="modal" data-target="#bannerModal"  @click="updateBannerId(banner.banners_id,banner.banners_title)"  class="img-fluid"v-bind:src="'/'+banner.path" alt="Banner Image">
                  </figure>
                </div>
                <div class="col-12 col-md-3">
                  <figure class="banner-image "v-for="banner in language.banners" v-if="banner.type == 36">
                    <img data-toggle="modal" data-target="#bannerModal"  @click="updateBannerId(banner.banners_id,banner.banners_title)"  class="img-fluid"v-bind:src="'/'+banner.path" alt="Banner Image">
                  </figure>
                </div>
                <div class="col-12 col-md-5">
                  <figure class="banner-image "v-for="banner in language.banners" v-if="banner.type == 34">
                    <img data-toggle="modal" data-target="#bannerModal"  @click="updateBannerId(banner.banners_id,banner.banners_title)"  class="img-fluid"v-bind:src="'/'+banner.path" alt="Banner Image">
                  </figure>
                </div>
              </div>
