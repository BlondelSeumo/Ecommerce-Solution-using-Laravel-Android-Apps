<template>
  ...
  <div class="banner-nine">
        ...
        <div class="container" v-for="language in languages">
          <h3 class="box-title">Choose / Set Banner for the "{{language.name}}"</h3>
            <div class="group-banners">
                <div class="row">
                  <div class="col-12 col-md-6">
                    <figure class="banner-image "v-for="banner in language.banners" v-if="banner.type == 19">
                  ...
                  <div class="col-12 col-md-6">
                    <figure class="banner-image "v-for="banner in language.banners" v-if="banner.type == 20">
                      <img data-toggle="modal" data-target="#bannerModal"  @click="updateBannerId(banner.banners_id,banner.banners_title)"  class="img-fluid"v-bind:src="'/'+banner.path" alt="Banner Image">
                    </figure>
                  </div>
