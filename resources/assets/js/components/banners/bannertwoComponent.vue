          ...
          <h3 class="box-title">Choose / Set Banner for the "{{language.name}}"</h3>
            <div class="row">
              <div class="col-12 col-md-8">
                <figure style="margin-bottom:34px;"class="banner-image" v-for="banner in language.banners" v-if="banner.type == 6">
                  <a><img data-toggle="modal" data-target="#bannerModal"  @click="updateBannerId(banner.banners_id,banner.banners_title)"  class="img-fluid"v-bind:src="'/'+banner.path" alt="Banner Image"></a>
                </figure>
                <div class="row">
                  <div class="col-12 col-md-6">
                    <figure class="banner-image " v-for="banner in language.banners" v-if="banner.type == 8">
                      <a><img data-toggle="modal" data-target="#bannerModal"  @click="updateBannerId(banner.banners_id,banner.banners_title)"  class="img-fluid"v-bind:src="'/'+banner.path" alt="Banner Image"></a>
                    </figure>
                  </div>
                  <div class="col-12 col-md-6">
                    <figure class="banner-image " v-for="banner in language.banners" v-if="banner.type == 9">
                      <a><img data-toggle="modal" data-target="#bannerModal"  @click="updateBannerId(banner.banners_id,banner.banners_title)"  class="img-fluid"v-bind:src="'/'+banner.path" alt="Banner Image"></a>
                    </figure>
                  </div>
                </div>
              ...
              <div class="col-12 col-md-4">
                <figure class="banner-image banner-column-5" v-for="banner in language.banners" v-if="banner.type == 7">
                  <a><img data-toggle="modal" data-target="#bannerModal"  @click="updateBannerId(banner.banners_id,banner.banners_title)"  class="img-fluid"v-bind:src="'/'+banner.path" alt="Banner Image"></a>
                </figure>
              </div>
