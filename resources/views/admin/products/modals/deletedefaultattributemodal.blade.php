...
{!! Form::open(array('url' =>'admin/deleteDefaultAttributeForm', 'name'=>'AttributeForm', 'id'=>'deletedefaultattributeform', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
...
<div class="modal-body">
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="deleteDefaultAttribute">{{ trans('labels.Delete') }}</button>
    </div>
    {!! Form::close() !!}
</div>