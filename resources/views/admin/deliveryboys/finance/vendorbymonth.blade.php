...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>{{$result['month']}} {{ trans('labels.Earning of') }} {{$result['earningsbymonth']['vendors']}}<small>{{$result['month']}} {{ trans('labels.Earning of') }} {{$result['earningsbymonth']['vendors']}}...</small> </h1>
        <ol class="breadcrumb">
            ...
            <li class="active">{{$result['month']}} {{ trans('labels.Earning of') }} {{$result['earningsbymonth']['vendors']}}</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">{{$result['month']}} {{ trans('labels.Earning of') }} {{$result['earningsbymonth']['vendors']}}</h3>
                    </div>
